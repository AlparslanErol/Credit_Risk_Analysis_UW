...
![image.png](attachment:567d2dc3-2121-4014-9e05-b37c24a7167d.png)
...
![image.png](attachment:45510b6d-80a9-42c9-a21e-5f7247ad967b.png)
...
<iframe
    width="1250"
    height="600"
    src="./Credit_Risk_Data_Pandas_Profile.html"
    frameborder="0"
    allowfullscreen
></iframe>
...
```
    ...
    Outliers:  [ 500000 1200000  948000  648000  504000  500000  500000  636000  510000
      612000  564000  552000  648000  703800  572400  522000  604000  741600
      750000  762000  762000  612000  604000 1200000 1200000  900000  900000
      708000  584800  700000  540600  500000  889000  528000 2039784  780000
      550000  550000  600000  499800  600000  780000  800000  828000  900000
     1362000 1440000  828000  780000  600000  900000  667680  500000 1782000
      720000  780000 1900000  780000]
    
    Feature:  person_emp_length
    Upper and Lower limits:  57.0 -48.0
    Number of outliers:  0
    Outliers Index:  []
    Outliers:  []
    
    Feature:  loan_amnt
    Upper and Lower limits:  84200.0 -67000.0
    Number of outliers:  0
    Outliers Index:  []
    Outliers:  []
    
    Feature:  loan_int_rate
    Upper and Lower limits:  59.30999999999999 -37.70999999999999
    Number of outliers:  0
    Outliers Index:  []
    Outliers:  []
    
    Feature:  loan_percent_income
    Upper and Lower limits:  1.6300000000000001 -1.31
    Number of outliers:  0
    Outliers Index:  []
    Outliers:  []
    
    Feature:  cb_person_cred_hist_length
    Upper and Lower limits:  58.0 -47.0
    Number of outliers:  0
    Outliers Index:  []
    Outliers:  []
    
    Number of rows with outliers:  58
    List of rows with outliers:  [15, 17833, 17834, 17840, 17846, 17847, 17848, 18635, 18917, 21462, 21958, 23429, 23431, 25714, 27798, 27877, 27881, 27882, 27883, 27884, 28253, 28633, 28770, 29119, 29120, 29121, 29122, 29126, 29127, 29128, 29129, 29131, 29345, 29514, 30049, 30536, 31911, 31912, 31913, 31914, 31915, 31916, 31918, 31919, 31921, 31922, 31924, 32037, 32070, 32291, 32298, 32300, 32303, 32497, 32543, 32544, 32546, 32551]
...
```
    ...
    accuracy: 0.7979704797047971
    precision: 0.5249529190207156
    recall: 0.7852112676056338
    f1 score: 0.6292325056433409
    None
    ...
    accuracy: 0.7976629766297663
    precision: 0.5244131455399061
    recall: 0.7866197183098591
    f1 score: 0.6292957746478873
    None
...
```
    ...
    accuracy: 0.8583948339483395
    precision: 0.764021164021164
    recall: 0.5084507042253521
    f1 score: 0.6105708245243129
    None
...
```
    ...
    Outliers Index:  [15, 15915, 17833, 17834, 17846, 17847, 17848, 18635, 18917, 21462, 21958, 23429, 23431, 27798, 27875, 27877, 27882, 27883, 27884, 28253, 28633, 28796, 29025, 29119, 29120, 29121, 29122, 29126, 29128, 29131, 29133, 29345, 29514, 30049, 30536, 31911, 31912, 31913, 31915, 31916, 31918, 31919, 31921, 31922, 31924, 32037, 32070, 32291, 32298, 32300, 32303, 32497, 32543, 32544, 32546, 32551, 28770, 28770, 31914, 27881, 27881, 31914, 29129, 17840, 31914, 27881, 17849, 29127, 27881, 31914, 27881, 27881, 27881, 28770, 27881, 25714, 17840, 17849, 31914, 29129, 29127, 31914, 17840, 31914, 17849]
    Outliers:  [ 500000  480000 1200000  948000  504000  500000  500000  636000  510000
      612000  564000  552000  648000  572400  480000  522000  741600  750000
      762000  762000  612000  480000  480000 1200000 1200000  900000  900000
      708000  700000  500000  480000  889000  528000 2039784  780000  550000
      550000  600000  600000  780000  800000  828000  900000 1362000 1440000
      828000  780000  600000  900000  667680  500000 1782000  720000  780000
     1900000  780000  604000  604000  499800  604000  604000  499800  540600
      648000  499800  604000  468000  584800  604000  499800  604000  604000
      604000  604000  604000  703800  648000  468000  499800  540600  584800
      499800  648000  499800  468000]
    
    Feature:  person_emp_length
    Upper and Lower limits:  56.0 -49.0
    Number of outliers:  0
    Outliers Index:  []
    Outliers:  []
    
    Feature:  loan_amnt
    Upper and Lower limits:  104000.0 -85000.0
    Number of outliers:  0
    Outliers Index:  []
    Outliers:  []
    
    Feature:  loan_int_rate
    Upper and Lower limits:  58.90999999999998 -35.16999999999998
    Number of outliers:  0
    Outliers Index:  []
    Outliers:  []
    
    Feature:  loan_percent_income
    Upper and Lower limits:  2.08 -1.7000000000000002
    Number of outliers:  0
    Outliers Index:  []
    Outliers:  []
    ...
    Number of rows with outliers:  64
    List of rows with outliers:  [15, 15915, 17833, 17834, 17840, 17846, 17847, 17848, 17849, 18635, 18917, 21462, 21958, 23429, 23431, 25714, 27798, 27875, 27877, 27881, 27882, 27883, 27884, 28253, 28633, 28770, 28796, 29025, 29119, 29120, 29121, 29122, 29126, 29127, 29128, 29129, 29131, 29133, 29345, 29514, 30049, 30536, 31911, 31912, 31913, 31914, 31915, 31916, 31918, 31919, 31921, 31922, 31924, 32037, 32070, 32291, 32298, 32300, 32303, 32497, 32543, 32544, 32546, 32551]
...
```
    ...
    accuracy: 0.786648313833448
    precision: 0.7889926485197695
    recall: 0.7818468202402048
    f1 score: 0.7854034810126582
    None
    ...
    accuracy: 0.786451676334677
    precision: 0.7891386512830714
    recall: 0.7810592636345738
    f1 score: 0.7850781713833367
    None
...
```
    ...
    List of rows with outliers:  [17840, 17849, 21462, 21958, 25714, 27877, 27881, 28253, 28770, 29121, 29127, 29129, 29345, 31911, 31914, 31916, 31919, 32303, 32544, 32546]
...
```
    ...
    recall: 0.7204225352112676
    f1 score: 0.8203688853247795
    None
    ...
    accuracy: 0.9320418204182042
    precision: 0.9553072625698324
    recall: 0.7225352112676057
    f1 score: 0.8227746591820368
    None
...
```
    ...
    accuracy: 0.935270602706027
    precision: 0.9725638599810785
    recall: 0.723943661971831
    f1 score: 0.8300363342753331
    None
    ...
    accuracy: 0.935270602706027
    precision: 0.9672591206735267
    recall: 0.7281690140845071
    f1 score: 0.8308557653676175
    None
    ...
    accuracy: 0.9354243542435424
    precision: 0.9690431519699813
    recall: 0.7274647887323944
    f1 score: 0.8310539018503621
    None
...
![png](output_160_1.png)
    ...
    Unique values are..: [0 1]
    Accurcy for test data..: 0.9361931119311193
    ROC for test data..: 0.9331454798816503
...
```
    ...
    accuracy: 0.9383456334563346
    precision: 0.9739534883720931
    recall: 0.7373239436619718
    f1 score: 0.8392785571142285
    None
    ...
    GridSearchCV(cv=RepeatedStratifiedKFold(n_repeats=1, n_splits=5, random_state=313),
                 estimator=Pipeline(steps=[('encoder',
                                            Custom_Encoder(binary_columns=['cb_person_default_on_file'],
                                                           ...
                                                           ordinal_colum...
                 n_jobs=-1,
                 param_grid=[{'clf__max_depth': [-1], 'clf__num_leaves': [31],
                              'from_model_selector__estimator': [LogisticRegression()],
...
```
    ...
    Pipeline(steps=[('encoder',
                    ...
                    ('kbest_selector',
                     SelectKBest(k='all',
                                 score_func=<function chi2 at 0x00000153C84A7948>)),
                    ('from_model_selector',
                     SelectFromModel(estimator=LogisticRegression(),
                                     threshold=-inf)),
                    ('scaler', MinMaxScaler()), ('clf', LGBMClassifier())])
...
![png](output_230_4.png)
    



    
![png](output_230_5.png)
    



    
![png](output_230_6.png)
    



    
![png](output_230_7.png)
    



    
![png](output_230_8.png)
    



    
![png](output_230_9.png)
    



    
![png](output_230_10.png)
    



    
![png](output_230_11.png)
    



    
![png](output_230_12.png)
    



    
![png](output_230_13.png)
    



    
![png](output_230_14.png)
    



    
![png](output_230_15.png)
    



    
![png](output_230_16.png)
    



    
![png](output_230_17.png)
    



    
![png](output_230_18.png)
    



    
![png](output_230_19.png)
    



    
![png](output_230_20.png)
    



    
![png](output_230_21.png)
...
![image.png](attachment:85c80ea4-4e17-4a66-a3ad-57681bb2b569.png)
...
![image.png](attachment:dafa78ab-8ee3-44b6-942e-e71dd3902932.png)
...
![image.png](attachment:e7e590ea-250d-49f6-ab4c-c56fea4283b2.png)

From Permutation Importance

![image.png](attachment:25f19d8f-1d9c-4ac2-a065-937701c4d992.png)

From the SHAP Values

![image.png](attachment:3f3eb671-23b0-4565-ab96-bf819ac53bb6.png)
...
![image.png](attachment:da23498d-6ce8-40ee-b8c6-e6fe6894a608.png)

And it can be seen that first 2 most important feature have changed the model's decision from correct to a wrong one.

![image.png](attachment:2388dbba-927e-4383-8ba2-ce801bd0f6a4.png)
